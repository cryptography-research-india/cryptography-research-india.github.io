...
permalink: /resources/topics/zero-knowledge-proofs/
---

<div class="page-hero">
  <div class="page-hero-overlay"></div>
  <div class="container">
    <h1 class="page-hero-title">Zero-Knowledge Proofs</h1>
    <p class="page-hero-subtitle">A deep-dive resource list on proving statements without revealing why they're true — coming soon.</p>
  </div>
</div>
